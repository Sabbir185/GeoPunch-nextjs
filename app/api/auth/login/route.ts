            ...
            return NextResponse.json(
                {
                    status: 404,
                    error: true,
                    msg: "User not found. Please check your email or password.",
                },
                {status: 404}
            );
        }
            ...
            return NextResponse.json(
                {
                    status: 200,
                    error: false,
                    msg: "Your account has been deactivated. Please contact your administrator for assistance.",
                    isDeleted: true
                },
                {status: 200}
            );
        ...
        const response = NextResponse.json(
            {
                ...
                data: {accessToken: device === "mobile" ? token : undefined}
            },
            {status: 200}
        );
