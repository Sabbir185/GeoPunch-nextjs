                    ...
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="hidden md:block">
                            <div className="ml-10 flex items-center space-x-6">
                                ...
                                <Link
                                    href="/activity"
                                    className="flex items-center gap-1.5 text-blue-600 font-semibold px-3 py-2 rounded-md text-sm bg-blue-50 border border-blue-200"
                                >
                ...
                {isMenuOpen && (
                    <div className="md:hidden">
                        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white/90 backdrop-blur-md border-t border-gray-200/50">
                            ...
                            <Link
                                href="/activity"
                                className="text-blue-600 font-semibold block px-3 py-2 rounded-md text-base bg-blue-50"
                                onClick={() => setIsMenuOpen(false)}
                            >
                                Activity Board (Live)
                            </Link>
