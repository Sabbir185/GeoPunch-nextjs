...
const navItems = [
    ...
    {
        title: "Place of Presence",
        icon: <LocateFixed size={20}/>,
        href: "/dashboard/place-of-presence",
    },
    {
        title: "Locations",
        icon: <MapPin size={20}/>,
                        ...
                        {navItems.map((item) => (
                            ...
                            >
                                <div className="flex items-center justify-start gap-[8px] h-full ml-[6px]">
                                    {item.icon}
                                    <span
                                        className="font-medium hover:font-semibold text-[15px] tracking-[-.2px] text-[#2B3241] inline-block font-inter">
                    {item.title}
                  </span>
                                </div>
                            </Link>
